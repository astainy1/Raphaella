...
class SectionContent extends React.Component {
  render() {
    return (
      <div data-aos="fade-up" className="h-auto md:h-80 bg-sky-900 py-10">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          
          <div data-aos="fade-down" data-aos-data-aos-delay="200" className="text-white p-4 text-lg">
          ...
          <div ata-aos="fade-up" data-aos-data-aos-delay="200" className="text-white p-4">
            <h1 className="text-lg sm:text-xl font-bold capitalize font-sans mb-2">
          ...
          <div ata-aos="fade-in" data-aos-data-aos-delay="200" className="text-white p-4">
            <h1 className="text-lg sm:text-xl font-bold capitalize font-sans mb-2">
          ...
          <div ata-aos="fade" data-aos-data-aos-delay="200" className="text-white p-4">
            <h1 className="text-lg sm:text-xl font-bold capitalize font-sans mb-2">
