    ...
    return (
      <>
        <div
          data-aos="fade-up"
          data-aos-delay="200"
          className="bg-white h-auto mb-32"
        >
          <h1 className="text-2xl font-sans font-bold m-10 md:m-24 md:text-3xl capitalize text-sky-900">
            Explore Autism Awareness Services - Together, we can break the
            stigma and build a brighter future for autistic children. Explore
            our services below to learn how we are making a difference!
          </h1>
          {/*service*/}
          ...
          <div
            data-aos="fade-up"
            data-aos-delay="200"
            className="flex flex-wrap justify-evenly gap-0"
          >
            <div className="w-72">
              <h1
                data-aos="fade-up"
                data-aos-delay="200"
                className="text-3xl capitalize text-sky-900 font-bold font-sans"
              >
              ...
              <ul className="pt-5">
                <li className="list-disc">
                  ...
                  <p className="text-sky-900 font-sans font-normal capitalize">
                    autism awareness services include teaching communities,
                    schools and churches about autism
                  </p>
                </li>
                ...
                <li className="list-disc pt-5">
                  ...
                  <p className="text-sky-900 font-sans font-normal capitalize">
                    spreading awareness about autism across liberia. the{" "}
                    <span className="uppercase">usa</span>, and africa.
                  </p>
                </li>
              </ul>
              {/*second column*/}
            ...
            >
              ...
              <ul className="pt-5">
                <li className="list-disc">
                  ...
                  <p className="text-sky-900 font-sans font-normal capitalize">
                    helping families understand autism and provide the best
                    care.
                  </p>
                </li>
                <li className="list-disc pt-3">
                ...
                <li className="list-disc pt-5">
                  ...
                  <p className="text-sky-900 font-sans font-normal capitalize">
                    teaching families how to use everyday items for sensory
            ...
            >
              ...
              <ul className="pt-5">
                ...
                <li className="list-disc pt-3">
                  ...
                  <p className="text-sky-900 font-sans font-normal capitalize">
                    collaborating with schools to create autism-friendly
                    classroom.
                  </p>
                </li>
                <li className="list-disc pt-5">
                  <b className="capitalize text-sky-900 text-xl">
                    <span className="uppercase">iep</span>(individualized
                ...
                <li className="list-disc pt-5">
                  ...
                  <p className="text-sky-900 font-sans font-normal capitalize">
                    working with families and teachers to ensure children
                    recieved the right accomodation.
                  </p>
                </li>
              </ul>
            </div>
